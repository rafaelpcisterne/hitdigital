...
$minCSS->add(dirname(__DIR__, 3) . "/themes/admin/assets/css/style.css");
$minCSS->minify(dirname(__DIR__, 3) . "/themes/admin/assets/style.min.css");
...
$minJS->add(dirname(__DIR__, 3) . "/themes/_shared/scripts/jquery.mask.js");
...
$minJS->add(dirname(__DIR__, 3) . "/themes/admin/assets/js/scripts.js");
$minJS->minify(dirname(__DIR__, 3) . "/themes/admin/assets/scripts.min.js");